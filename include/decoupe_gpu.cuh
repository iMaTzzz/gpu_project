...
*/
extern void treat_image_grey_gpu(FILE *image, uint32_t width, uint32_t height, struct huff_table *ht_dc, 
...
/*
    ...
    avant de passer à la suivante. 
*/
extern void treat_image_color_gpu(FILE *image, uint32_t width, uint32_t height, struct huff_table *ht_dc_Y, 
